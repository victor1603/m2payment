...
class PbPartsPayment extends Action
{
    ...
    public function execute()
    {
        try {
            ...
            $partsCount = 2;
            if ($this->getRequest()->getParam(PbPartsPaymentModel::ATTRIBUTE_TERM_CODE)) {
                $partsCount = (int)$this->getRequest()->getParam(PbPartsPaymentModel::ATTRIBUTE_TERM_CODE);
            }
            if ($order->getPayment()->getMethod() == PbPartsPaymentModel::METHOD_CODE) {
